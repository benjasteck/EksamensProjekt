...
if ( !isset( $_SERVER[ "PHP_AUTH_USER" ] ) || ( $_SERVER[ "PHP_AUTH_USER" ] != "6729db1d1041339ac002e967c0736a61" && $_SERVER[ "PHP_AUTH_PW" ] != "6729db1d1041339ac002e967c0736a61" ) ) {
	header( "WWW-Authenticate: Basic realm=\"WP-Super-Cache Debug Log\"" );
	header( $_SERVER[ "SERVER_PROTOCOL" ] . " 401 Unauthorized" );
	echo "You must login to view the debug log";
	exit( 0 );
}
$debug_log = file( "./005c34c8199b10e1d383ea4bd0d8e7be.php" );
...
<p>If you must share it please remove any cookies and remove any directories such as C:\Users\benja\Local Sites\sikkerhedsgiganten\app\public/.</p>
Exclude requests: <br />
...
<?php
$path_to_site = "C:\Users\benja\Local Sites\sikkerhedsgiganten\app\public/";
